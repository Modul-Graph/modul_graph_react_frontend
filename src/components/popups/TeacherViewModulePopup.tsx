...
export default function TeacherViewModulePopup(cellID: string, open: boolean) {}

function _TeacherViewModulePopup(props: TeacherViewModulePopupProps) {
    return (
                ...
                <CardContent>
                    <Stack spacing={1}>
                        ...
                        <Card variant={"outlined"}>
                            ...
                            <CardContent>{props.providedAt}</CardContent>
                        </Card>
                        <Card variant={"outlined"}>
                            <CardHeader title="Required Competences" />
                            <CardContent>
                                <DiscList>
                                    {props.requriedCompetences.map((comp) => (
                                        <DiscListItem>{comp}</DiscListItem>
                                    ))}
                                </DiscList>
                            </CardContent>
                        </Card>
                        <Card variant={"outlined"}>
                            ...
                            <CardContent>
                                <DiscList>
                                    {props.providedCompetences.map((comp) => (
                                        <DiscListItem>{comp}</DiscListItem>
                                    ))}
                                </DiscList>
                            </CardContent>
