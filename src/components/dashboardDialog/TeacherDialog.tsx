    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>Bitte geben sie einen Modulnamen ein.</DialogContentText>
                    <TextField
                        autoFocus
                        required
                        margin="dense"
                    ...
                    />
                    <SelectModuleArea />
                    <DialogContentText>benötigte Kompetenzen</DialogContentText>
                    <SelectRequiredCompetence />
                    <DialogContentText>bereitgestellte Kompetenzen</DialogContentText>
