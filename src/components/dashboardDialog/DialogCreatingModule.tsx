...
export const DialogCreatingModule = () =>
{
    ...
    return(<GenericDialog title={"Modul hinzufügen"} buttons={ <ButtonCreateModule moduleName={moduleName} creditPoints={creditPoints} providedCompetenceName={providedCompetenceName}
            requiredCompetenceName={requiredCompetenceName} winter={winter} summer={summer} moduleAreaName={moduleAreaName} compulsoryModule={compulsoryModule} studyPO={studyPO}/>}  >
