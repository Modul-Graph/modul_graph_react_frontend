...
export default function SelectRequiredCompetencies({
    competences,
    requiredCompetenceName,
    setRequiredCompetenceName,
}: RequiredCompetencesProps) {
...
type RequiredCompetencesProps = {
    competences?: string[];
    requiredCompetenceName?: string[];
    setRequiredCompetenceName?: (comp: string[]) => void;
};
