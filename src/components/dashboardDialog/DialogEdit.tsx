...
import {SearchModule} from "@/components/dashboardDialog/SearchModule";

export const DialogEdit = () =>
{

    return(<GenericDialog title={"Modul bearbeiten"} buttons={ <Button type="submit">in Ansicht bearbeiten</Button>}>
